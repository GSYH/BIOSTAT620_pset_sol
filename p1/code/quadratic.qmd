...
```{r}
coefs1 = read.table(file.path(getwd(), "p1/data/coefs1.txt"))

coefs2 = read.table(file.path(getwd(), "p1/data/coefs2.txt"))

coefs3 = read.table(file.path(getwd(), "p1/data/coefs3.txt"))
...
for (n in 1:length(all_solutions)) {
  result_file <- paste0(file.path(getwd()), "/p1/results/results", n, ".txt")
